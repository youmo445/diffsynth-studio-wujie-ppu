...
Example:
    ...
    python examples/wanvideo/model_inference/Wan2.2-agi-VACE-1.3B_multiview_codex.py \
        --val_path /mnt/workspace/zsq/Agi2024subset_split/val \
        --output_dir /mnt/workspace/zsq/DiffSynth-Studio/outputs/infer_multiview_codex \
        --vace_model_path /mnt/workspace/zsq/DiffSynth-Studio/outputs/Wan2.1-VACE-1.3B-multiview-perspective/epoch-9.safetensors \
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="/mnt/workspace/zsq/Agi2024subset_split/val_gen")
