...
def main():
    ...
    parser.add_argument("--model_paths", nargs=4, default=[
        "/mnt/workspace/zsq/DiffSynth-Studio/outputs/Wan2.2-Fun-A14B-Control_high_niose_full_continue/epoch-18.safetensors",
        "/mnt/workspace/zsq/DiffSynth-Studio/outputs/Wan2.2-Fun-A14B-Control_low_niose_full_continue/epoch-18.safetensors",
