...
pipe = WanVideoPipeline.from_pretrained(
    ...
    device="cuda:0",
    model_configs=[
        ModelConfig(path="/mnt/workspace/zsq/Wan_model/Wan2.2-VACE-Fun-A14B/high_noise_model/diffusion_pytorch_model.safetensors"),
        ModelConfig(path="/mnt/workspace/zsq/Wan_model/Wan2.2-VACE-Fun-A14B/low_noise_model/diffusion_pytorch_model.safetensors"),
        ModelConfig(path="/mnt/workspace/zsq/Wan_model/Wan2.2-VACE-Fun-A14B/models_t5_umt5-xxl-enc-bf16.pth"),
        ModelConfig(path="/mnt/workspace/zsq/Wan_model/Wan2.2-VACE-Fun-A14B/Wan2.1_VAE.pth"),
    ],
)
