...
def load_pipe(base_model_paths, vace_model_path):
...
def main():
    ...
    parser.add_argument("--vace_model_path",default="/mnt/workspace/zsq/DiffSynth-Studio/outputs/Wan2.1-VACE-1.3B/epoch-49.safetensors")
    ...
    # load model
    pipe = load_pipe(args.base_model_paths, args.vace_model_path)
