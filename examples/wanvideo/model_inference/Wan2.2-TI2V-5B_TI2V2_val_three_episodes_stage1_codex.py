    ...
    if args.parallel_episodes and not args.worker:
        ...
        for ep, gpu_id in zip(episodes, gpu_ids):
            cmd = [
                ...
                str(args.fps),
                "--view_height",
                str(args.view_height),
                "--view_width",
                str(args.view_width),
                "--traj_radius",
                str(args.traj_radius),
                "--traj_radius_mode",
                args.traj_radius_mode,
                "--traj_min_radius",
                str(args.traj_min_radius),
                "--traj_max_radius",
                str(args.traj_max_radius),
                "--traj_ref_depth",
                str(args.traj_ref_depth),
                "--traj_near_depth",
                str(args.traj_near_depth),
                "--traj_far_depth",
                str(args.traj_far_depth),
                "--ray_o_vmin",
                str(args.ray_o_vmin),
                "--ray_o_vmax",
                str(args.ray_o_vmax),
            ...
            if args.orig_height is not None:
                cmd.extend(["--orig_height", str(args.orig_height)])
            if args.orig_width is not None:
                cmd.extend(["--orig_width", str(args.orig_width)])
