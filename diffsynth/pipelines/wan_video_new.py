...
class WanVideoUnit_InputVideoEmbedder(PipelineUnit):
    ...
    def process(self, pipe: WanVideoPipeline, input_video, noise, tiled, tile_size, tile_stride, vace_reference_image):
        if input_video is None:
            # print(f'latents:{noise.shape}') # [1, 16, 4, 40, 64]
        ...
        if vace_reference_image is not None:
            ...
            # print(f'vace_reference_latents:{vace_reference_latents.shape}')
...
class WanVideoUnit_PromptEmbedder(PipelineUnit):
    ...
    def process(self, pipe: WanVideoPipeline, prompt, positive) -> dict:
        ...
        # print(f'context:{prompt_emb.shape}') # [1. 512. 4096]
...
class WanVideoUnit_FunReference(PipelineUnit):
    ...
    def process(self, pipe: WanVideoPipeline, reference_image, height, width):
        ...
        if pipe.image_encoder is None:
            print(f'reference_latents:{reference_latents.shape}') # [1, 16, 1, 40, 64]
    ...
    def process(
        ...
        if vace_video is not None or vace_video_mask is not None or vace_reference_image is not None:
            ...
            if vace_reference_image is None:
                ...
                vace_reference_image = pipe.preprocess_video(vace_reference_image)
                # print(f'vace_reference_image:{vace_reference_image.shape}') # [1, 3, 1, 480, 640]
...
def model_fn_wan_video(
    ...
    **kwargs,
    ...
    if clip_feature is not None and dit.require_clip_embedding:
        ...
        print(f'clip_emb:{clip_embdding.shape}')
    ...
    if reference_latents is not None:
        ...
        print(f'reference_latents:{reference_latents.shape}')
